...
- Complete the approved test commands and inspect their results before dispatching lint. Preserve
  the requested verification order; do not start lint first or batch it ahead of unfinished tests.
  If integration setup is blocked, report that outcome before running any independent lint check.
