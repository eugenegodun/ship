...
def _milestone_transcript(*, fix_round=False):
    ...
    return [
        {"role": "user", "content": (
            ...
            "The systematic-debugging and verification-before-completion skills are already loaded: "
            "diagnose from the supplied error evidence before fixing anything, and only claim checks "
            "that their output proves. No skill discovery or loading is needed in this simulation. "
